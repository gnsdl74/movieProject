...
public class BookingController {
	...
	public String booking(Model model) {
		...
		ScheduleDetailVO scheduleVO = new ScheduleDetailVO(0, today, currentTime, null, null, null, 0, 0, 0);
	...
	public ResponseEntity<List<ScheduleDetailVO>> readScheduleListByDate(@PathVariable String strDate) {
		...
		ScheduleDetailVO scheduleVO = new ScheduleDetailVO(0, date, null, null, null, null, 0, 0, 0);
	...
	public ResponseEntity<List<ScheduleDetailVO>> readScheduleListByMovie(@PathVariable String strDate,
		...
		ScheduleDetailVO scheduleVO = new ScheduleDetailVO(0, date, null, null, null, null, 0, 0, movieNo);
