...
<body>
	...
	<div class="main">
		...
		<!-- 아이디, 비밀번호 Tab -->
		<!--디폴트 메뉴 : tab menu1-->
		<input id="findId" class="findInfo" type="radio" name="tabs" checked>
		<label for="findId" class="titleNm">아이디 찾기</label> <input id="findPw"
			class="findInfo" type="radio" name="tabs"> <label
			for="findPw" class="titleNm">비밀번호 찾기</label>
		<!-- // 아이디, 비밀번호 Tab -->
			...
			<div class="container">
				...
				<div class="content">
					<table>
						<tr>
							<th>이름</th>
							<td><input id="idName" type="text" placeholder="이름"></td>
						</tr>
						<tr>
							<th>생년월일</th>
							<td><input id="idBirth" type="text" placeholder="생년월일 앞8자리">
								<label id="birthError"></label></td>
						</tr>
						<tr>
							<th>이메일</th>
							<td><input id="idEmail" type="text" placeholder="이메일">
			...
			<div class="container">
				...
				<div class="content">
					<table>
						<tr>
							<th>아이디</th>
							<td><input id="pwId" type="text" placeholder="아이디"></td>
						</tr>
						<tr>
							<th>이름</th>
							<td><input id="pwName" type="text" placeholder="이름"></td>
						</tr>
						<tr>
							<th>휴대폰 번호</th>
							<td><input id="pwPhone" type="text" placeholder="'-'없이 입력">
								<button id="authSend" class="btn-auth" disabled>인증요청</button></td>
						</tr>
						<tr id="confirmTr">
							<th>인증번호</th>
							<td><input id="phoneCheck" type="text" disabled>
							<div>
									<p id="timer">3:00</p>
								</div>
